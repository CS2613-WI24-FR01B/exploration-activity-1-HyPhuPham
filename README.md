...
My name is Phu Hy Pham - ID: 3741975

My exploration activity 1 is a calculator application
...
### To use
* On the terminal - first we use the command line: "pip install pyqt5"

* On the program 

-> To initialize: use "from PyQt5.QtWidgets import...(widgets)"

-> To initialize: use "import sys"
...
- Declare a button called "AC" itself
